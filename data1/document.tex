...
\begin{figure}[htbp]
  \begin{adjustwidth}{-2in}{-2in}
	  \centering
	  \subfloat[Hickory \& Maple]{\label{fig:ppcf_hm}\includegraphics[width=0.4\textwidth]{ppcfi_hickory_maple}}
	  \subfloat[Hickory \& Oak]{\label{fig:ppcf_ho}\includegraphics[width=0.4\textwidth]{ppcfi_hickory_oak}}
	  \subfloat[Oak \& Maple]{\label{fig:ppcf_hm}\includegraphics[width=0.4\textwidth]{ppcfi_maple_oak}}
  \end{adjustwidth}
