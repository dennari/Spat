...
A marked point process can depart from complete randomness in multiple ways:
\begin{itemize}
...
Testing for these different null hypotheses is 
done by considering the ``cross" versions of the second order summary functions of the process.
...
\subsubsection{$L_{ij}$ function}

\subsubsection{$L_{i\bullet}$ function}

\subsubsection{mark-connection function}
