###########################################################################
## simulated.R
## Simulates and then inferrs LGCPs based on the method described in
## Simpson et al. (2011).
...
#Construct mesh (regular mesh!), not meshed to points.  To change this for a new data set,
#just change the max.edge bit to an appropraite number (it's the largest edge length).
#Just run the command and plot the mesh until you get something that looks sensible.
